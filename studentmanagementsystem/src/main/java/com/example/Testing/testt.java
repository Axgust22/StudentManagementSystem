...
public class testt extends JFrame {
    ...
    public testt() {
        ...
        b2.addActionListener(e -> new testing8(model));
        ...
        // } else {
        // JOptionPane.showMessageDialog(null, "No button selected for deletion!",
        // "Error",
        ...
        b7.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                RoundedButton selectedButton = getSelectedButton();
                ...
                if (selectedButton != null) {
                    ...
                    // Refresh only the affected part
                    p3.revalidate();
                    p3.repaint();
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (selectedButton != null) {
                    ...
                    if (newName != null && !newName.trim().isEmpty()) {
                        ...
                        // Refresh only the affected parts
                    ...
                    JOptionPane.showMessageDialog(null, "No button selected!", "Error", JOptionPane.ERROR_MESSAGE);
                }
            }
        });
        ...
        b6.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                int yPosition = 50 + (newButtons.size() * 50); // Position each new button below the previous one
    ...
    // Helper method to get the selected button
    private RoundedButton getSelectedButton() {
        for (RoundedButton button : newButtons) {
            if (button.getBackground().equals(Color.CYAN)) { // Use a constant if possible
                return button;
            }
        }
